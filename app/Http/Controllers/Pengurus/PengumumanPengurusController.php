...
class PengumumanPengurusController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('back-end.pengurus.pengumuman.index', compact('data'));
    }
    ...
    {
        return view('back-end.pengurus.pengumuman.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('back-end.pengurus.pengumuman.show', compact('pengumuman'));
    }
    ...
    {
        $pengumuman = Pengumuman::findOrFail($id);
        return view('back-end.pengurus.pengumuman.edit', compact('pengumuman'));
    }
