...
class GaleryFotoAdminController extends Controller
{
    public function index()
    {
        $fotos = GaleriFoto::latest()->paginate(10);
        return view('back-end.admin.foto.index', compact('fotos'));
    }

    public function create()
    {
        return view('back-end.admin.foto.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('back-end.admin.foto.show', compact('galeri'));
    }

    public function edit($id)
    {
        $foto = GaleriFoto::findOrFail($id);
        return view('back-end.admin.foto.edit', compact('foto'));
    }
