...
@section('content')
    <section class="flex items-center justify-center h-[70vh]">
        <div class="bg-yellow-100 dark:bg-yellow-900 p-10 rounded-xl shadow-lg text-center max-w-lg">
            ...
            <p class="text-gray-700 dark:text-gray-300 mb-4">
                Mohon maaf, fitur <span class="font-semibold">Sistem informasi Monitoring Kegiatan Santri (SIMKES)</span>
