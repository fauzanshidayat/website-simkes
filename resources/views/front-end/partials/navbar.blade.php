<!-- Navbar -->
<nav
    class="w-full flex items-center justify-between px-6 md:px-20 py-4 bg-[#067344] shadow-lg fixed top-0 z-50 sr-title">
    ...
    <ul class="hidden md:flex space-x-8 font-semibold text-lg text-white">
        ...
        <li class="relative group">
            <a href="#" class="hover:text-[#FFBB00] transition inline-flex items-center gap-1">
                Profil
            ...
            <!-- Dropdown -->
            <div
                class="absolute left-0 top-full mt-2 w-44 bg-white text-black rounded shadow-lg opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity duration-200 z-50">
        ...
        <li class="relative group">
            ...
            <!-- Dropdown -->
            <div
                class="absolute left-0 top-full mt-2 w-40 bg-white text-black rounded shadow-lg opacity-0 group-hover:visible group-hover:opacity-100 transition-opacity duration-200 z-50">
        ...
        <li class="relative group">
            ...
            <div
                ...
                <a href="{{ route('simkes') }}" class="block px-4 py-2 hover:bg-gray-100">SIMKES</a>
...
<!-- Mobile Menu -->
<div class="hidden fixed top-16 left-0 w-full bg-[#067344] shadow-lg z-40 md:hidden" id="mobile-menu">
    <ul class="flex flex-col space-y-4 p-6 font-semibold text-lg text-white">
        ...
        <li>
            <button
                ...
                Profil
                <svg class="w-4 h-4 transform transition-transform duration-300 dropdown-icon" fill="none"
            ...
            <ul class="hidden mt-2 ml-4 space-y-2 dropdown-menu">
                ...
                <li><a href="{{ route('visi-misi') }}" class="block hover:text-[#FFBB00] transition">Visi & Misi</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="hidden mt-2 ml-4 space-y-2 dropdown-menu">
                <li><a href="{{ route('madrasah-tsanawiyah') }}"
                        class="block hover:text-[#FFBB00] transition">MTS</a>
                </li>
                <li><a href="{{ route('madrasah-aliyah') }}" class="block hover:text-[#FFBB00] transition">MA</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul class="hidden mt-2 ml-4 space-y-2 dropdown-menu">
                <li><a href="{{ route('berita.index') }}" class="block hover:text-[#FFBB00] transition">Berita &
                        Artikel</a></li>
                <li><a href="{{ route('pengumuman.index') }}"
                        class="block hover:text-[#FFBB00] transition">Pengumuman</a></li>
                <li><a href="{{ route('simkes') }}" class="block hover:text-[#FFBB00] transition">SIMKES</a></li>
                <li><a href="https://shorturl.at/BYi5I" target="_blank"
                        class="block hover:text-[#FFBB00] transition">PSB</a></li>
