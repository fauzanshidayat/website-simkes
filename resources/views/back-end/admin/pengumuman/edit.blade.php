...
@section('content')
    <section class="max-w-4xl mx-auto bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Edit Pengumuman</h2>
        ...
        <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input id="deskripsi" type="hidden" name="deskripsi" value="{{ old('deskripsi', $pengumuman->deskripsi) }}">
                <!-- Trix Editor -->
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div
                        ...
                        @if ($pengumuman->gambar)
                            <img id="preview" src="{{ asset('storage/' . $pengumuman->gambar) }}" alt="Gambar Lama"
