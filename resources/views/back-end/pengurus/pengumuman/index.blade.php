    ...
    <section class="grid grid-cols-1 gap-8">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div class="flex justify-start gap-4 p-3">
                <a href="{{ route('pengurus.pengumuman.create') }}"
