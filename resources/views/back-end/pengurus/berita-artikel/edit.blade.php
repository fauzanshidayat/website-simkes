...
@section('content')
    <section class="max-w-4xl mx-auto bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Edit Berita</h2>

        <form action="{{ route('pengurus.berita-artikel.update', $berita->id) }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <!-- Deskripsi -->
             <div>
                ...
                <!-- Hidden input untuk menyimpan value -->
            ...
            <div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div
                        ...
                        @if ($berita->gambar)
                            <img id="preview" src="{{ asset('storage/' . $berita->gambar) }}" alt="Gambar Lama"
